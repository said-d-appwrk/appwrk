...
function pipdisqus_count_script() {
	...
	$disqus_count = 'https://'.trim($options['disqus_shortname']).'.disqus.com/count.js';
	?>
...
/*
function pipdisqus_filter_comment_link($url) {
	return $link.'#disqus_thread';
}
add_filter('comment_link', 'pipdisqus_filter_comment_link');
*/
...
function pipdisqus_adminbar($admin_bar){
	...
	$disqus_url = 'https://'.trim($options['disqus_shortname']).'.disqus.com/admin/moderate/';
