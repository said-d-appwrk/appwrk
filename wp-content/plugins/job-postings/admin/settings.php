								...
								?>
									...
									<div class="row clearfix">
										...
										<?php
											...
											echo '<p class="description jfw_hint">'.__("On some servers it is not possible to use \"Secure Location\" outside of the site's root folder, because of the limitet permissions.", 'job-postings').'</p>';
										?>
										</div>
									</div>
