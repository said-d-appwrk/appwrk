...
$mail_subject = "Event Rescheduled: {$mail_data['service_name']} event has been rescheduled.";
          ...
          <tr>
            <td style="padding: 10px 0;">
              <span style="color: #7c7d9c;"
                >Hi{$hi_name}, <br />An event has been rescheduled.</span
              >
            </td>
          </tr>
          <tr>
