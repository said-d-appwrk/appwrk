...
$mail_subject = "Event Rescheduled: With {$mail_data['booking_admin_display_name']} at {$mail_data['booking_from_to_time_str_with_tz']}.";
      ...
      >
        ...
        <table>
          <tr>
            <td style="padding: 10px 0;">
              <span style="color: #7c7d9c;"
                >Hi{$hi_name}, <br />Your event with {$mail_data['booking_admin_display_name']} has been rescheduled.</span
              >
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding: 10px 0;">
              <strong style="font-size: 11px; text-transform: uppercase;"
                >Former Date & Time</strong
              ><br />
              <span style="color: #7c7d9c; text-decoration: line-through;"
                >{$mail_data['reschedule_booking_from_to_time_str_with_tz']}</span
              >
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="padding: 10px 0;display:none;">
              <strong style="font-size: 11px; text-transform: uppercase;"
                >Rescheduled by</strong
              ><br />
